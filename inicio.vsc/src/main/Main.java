...
//    	//GrammarLexer lexer = new GrammarLexer(CharStreams.fromFileName("definicionVariables.txt"));
//        GrammarLexer lexer = new GrammarLexer(CharStreams.fromFileName("ejemplo.txt"));
//        //GrammarLexer lexer = new GrammarLexer(CharStreams.fromFileName("Hipoteca.txt"));
//
 ...
 */
public class Main {
	public static final String INPUT_FILE = "tests-semantic/2. Estructuras.txt"; // Fichero de prueba durante el desarrollo
	...
	public static AST compile(String sourceName, ErrorManager errorManager) throws Exception {
		...
		if (parser.getNumberOfSyntaxErrors() > 0 || ast == null) { // Hay errores o el AST no se ha implementado aún
			errorManager.notify("Compilación correcta");
