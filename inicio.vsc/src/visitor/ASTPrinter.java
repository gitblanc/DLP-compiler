...
public class ASTPrinter extends DefaultVisitor {
	...
	public Object visit(VariableStruct node, Object param) {
		...
		printName(indent, "VariableStruct", node, false);
	...
	public Object visit(StructTipo node, Object param) {
		...
		printCompact(indent, "StructTipo", node, "nombre", node.getNombre());
		return null;
	}
	...
	public Object visit(If node, Object param) {
		...
		visit(indent + 1, "if_true", "List<Sentencia>",node.getIf_true());
		visit(indent + 1, "if_false", "List<Sentencia>",node.getIf_false());
		return null;
	}
